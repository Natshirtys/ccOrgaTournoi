    ...
    <Card className="overflow-hidden shadow-sm">
      ...
      <CardContent className="p-0">
        ...
        <div className="divide-y">
          {/* En-tête du tableau */}
          <div className="grid grid-cols-[1.5rem_1fr_5rem_2rem_2rem_3rem_3rem_3rem_2.5rem] items-center gap-x-2 px-4 py-1.5 text-[11px] font-semibold uppercase tracking-wide text-muted-foreground">
          ...
          {classement.map((team, idx) => {
            ...
            return (
              <div
                key={team.equipeId}
                className={cn(
                  'grid grid-cols-[1.5rem_1fr_5rem_2rem_2rem_3rem_3rem_3rem_2.5rem] items-center gap-x-2 border-l-4 px-4 py-2.5 text-sm',
                  rrConfig
              ...
              >
                ...
                {/* Pm */}
                <span className="text-center tabular-nums text-xs text-emerald-700">{team.pointsMarques}</span>
                {/* Pe */}
                <span className="text-center tabular-nums text-xs text-destructive/70">{team.pointsEncaisses}</span>
                {/* Diff */}
                <span className={cn('text-center text-xs tabular-nums font-medium', diff > 0 ? 'text-emerald-700' : diff < 0 ? 'text-destructive' : 'text-muted-foreground')}>
                  {diff > 0 ? `+${diff}` : diff}
                </span>
                {/* Pts */}
